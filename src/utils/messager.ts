...
export async function getMessage(
  ...
  const costumerInDebt = await allCosturmers.find(
...
const emailExample: {
  ...
  late: ({ value, date, description, name }) => `Prezado(a)%20Sr.%20${name}.1+%0A+Esperamos%20que%20este%20e-mail%20o%20encontre%20bem.%20Estamos%20escrevendo%20para%20lembrá-lo(a)%20de%20que%20sua%20dívida%20conosco%20venceu.1+%0A+Detalhes%20da%20dívida:1+%0A+Novo%20Valor:%20R$${Number(value).toFixed(2)}1+%0A+Data%20de%20Vencimento:%20${String(date).split("T")[0].split("-").join("/")}1+%0A+Descrição%20da%20Dívida:%20${description}1+%0A+Por%20favor,%20tome%20as%20medidas%20necessárias%20para%20garantir%20que%20o%20pagamento%20seja%20feito%20até%20a%20data%20de%20vencimento%20mencionada%20acima.%20Se%20você%20já%20efetuou%20o%20pagamento,%20por%20favor,%20desconsidere%20esta%20mensagem.`,
};
